...
class Activation_Softmax:
    ...
    def backward(self, dvalues):
        ...
        for index, (single_output, single_dvalues) in enumerate(zip(self.output, dvalues)):
            ...
            jacobian_matrix = np.diagflat(single_dvalues) - \
...
class Optimizer_Adagard:
    ...
    def update_params(self, layer):
        ...
        layer.dweights += -self.current_learning_rate * layer.dweights / (np.sqrt(layer.weight_cache) + self.epsilon)
